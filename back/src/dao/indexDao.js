...
exports.selectDairoum = async function (connection, category){
  const selectAllDairoumQuery = `SELECT title, address, category FROM Dairoum where status = 'A';`;
  const selectCategorizedDairoumQuery = `SELECT title, address, category FROM Dairoum where status = 'A' and category = ?;`;

  const Params = [category];

  const Query = category ? selectCategorizedDairoumQuery : selectAllDairoumQuery;
